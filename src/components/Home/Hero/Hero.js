        ...
        <div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
                {/* {
                    heroProducts.map(product =>
                        <div key={product.key} className="carousel-item" data-bs-interval="2000">
                            ...
                            <h3 style={{ fontSize: '18px', color: '#212529' }} className='text-center fw-bold my-3'>Price: Rs. {product.price} </h3>
                        </div>
                    )
                ...
                <div className="carousel-item active" data-bs-interval="1000">
                    ...
                    <h3 style={{ fontSize: '18px', color: '#212529' }} className='text-center fw-bold my-3'>Price: Rs.22000 </h3>
                </div>
                ...
                <div className="carousel-item" data-bs-interval="2000">
                    ...
                    <h3 style={{ fontSize: '18px', color: '#212529' }} className='text-center fw-bold my-3'>Price: Rs.33000 </h3>
                </div>
                ...
                <div className="carousel-item" data-bs-interval="2000">
                    ...
                    <h3 style={{ fontSize: '18px', color: '#212529' }} className='text-center fw-bold my-3'>Price: 16000 Rs.</h3>
                </div>
            </div>
